...
<section class="author-info-area section-bg">
                ...
                <div class="col-lg-12">
                    <div class="dashboard-nav-area">
                        <ul class="nav" id="dashboard-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="messages-tab" data-toggle="tab" href="#messages-tab-pane" role="tab" aria-controls="favorite" aria-selected="false">Inbox</a>
                            </li>
                        </ul>
                        <div class="nav_button">
                            <a href="../../../../direohtml/src/add-listing.html" class="btn btn-primary"><span class="la la-plus"></span> Add Listing</a>
    ...
    <div class="tab-content p-top-100" id="dashboard-tabs-content">
                                            ...
                                            <c:forEach items="${favoris}" var="fav">
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <c:forEach items="${gallerieArray}" var="gal">
        ...
        <div class="tab-pane fade p-bottom-30" id="messages-tab-pane" role="tabpanel" aria-labelledby="messages">
            <div class="container">
                <div class="row">
                            ...
                            <table id="directorist-checkout-table" class="table table-bordered">
                                ...
                                <c:forEach var="msg" items="${messages}">
                                    <tr>
                                        ...
                                        <td>
                                            <c:set var="sender" value="${msg.getSender()}" />
                                            <c:set var="receiver" value="${msg.getReceiver()}"/>
                                            <c:if test="${sender.getId() == currentUser.getId()}">
                                                <h4>Sent to => ${receiver.getNom()} ${receiver.getPrenom()}</h4>
                                            </c:if>
                                            <c:if test="${receiver.getId() == currentUser.getId()}">
                                                <h4>Sent by => ${sender.getNom()} ${sender.getPrenom()}</h4>
                                            </c:if>
                                            <p>${msg.getText()}</p>
                                        </td>
                                        <td>
